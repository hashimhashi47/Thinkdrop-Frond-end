...
import { User, ArrowLeft, Loader2, UserPlus, UserMinus, Users } from "lucide-react";
...
export default function UserProfile() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                // Initial fetch: Profile and Posts (Writings)
                ...
                setUser(profileData);
                setPosts(postsData);
                // We don't fetch Followers/Following for visitors (privacy)
        ...
        <div className="min-h-screen bg-[#1E1E2E]">
            ...
            <main className="max-w-4xl mx-auto py-8 px-4">
                ...
                <div className="bg-[#2D2D44] rounded-3xl p-8 mb-8 border border-white/5 shadow-xl relative overflow-hidden">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            ...
                            <p className="text-brand-primary font-medium text-sm mb-4">{user.anonymousName}</p>
                            ...
                            <div className="flex flex-col md:flex-row items-center gap-6">
                                ...
                                <div className="flex items-center gap-8 text-sm">
                                    <div className="text-center md:text-left">
                                        <span className="block text-xl font-bold text-brand-primary">{user.stats.writings}</span>
                                        <span className="text-xs text-gray-500 font-bold uppercase tracking-wider">Writings</span>
                                    </div>

                                    {/* Hiding numbers for visitors as per privacy request */}
                                    <div className="text-center md:text-left opacity-60">
                                        <span className="block text-xl font-bold text-gray-300">Hidden</span>
                ...
                <div className="flex items-center gap-6 border-b border-white/10 mb-6 overflow-x-auto">
                    <button
                        className="pb-3 font-bold text-sm transition-colors relative whitespace-nowrap text-brand-primary"
                    >
                        Writings
